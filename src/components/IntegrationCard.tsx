...
export function IntegrationCard({ integration, onTestConnection }: IntegrationCardProps) {
    ...
    <div className="bg-mc-bg-secondary border border-mc-border rounded-lg p-4 hover:border-mc-accent/50 transition-colors">
      ...
      <div className="flex items-center justify-between pt-3 border-t border-mc-border/50">
        ...
        <button
          ...
          className="flex items-center gap-1.5 px-3 py-1 text-xs font-medium bg-mc-bg-tertiary text-mc-text-secondary hover:text-mc-text rounded hover:bg-mc-bg transition-colors"
        >
